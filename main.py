...
def transform_datastruct(news_data):
...
class SupabaseUploader:
    ...
    def upload_data(self, news_data: List[Dict[str, str]], table_name: str = "news") -> None:
        """
    ...
    async with httpx.AsyncClient(timeout=100.0) as client:
        try:
            for cate in category_list:
                ...
                transformed_data = transform_datastruct(response.json())
